...
if __name__ == "__main__" and not __package__:
    ...
    import crfnet_distance.data_processing.generator  # noqa: F401
    __package__ = "crfnet_distance.data_processing.generator"
...
class NuscenesGenerator(Generator):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if self._is_image_plus_enabled() or self.camera_dropout > 0.0:
            ...
            from crfnet_distance.data_processing.fusion.fusion_projection_lines import imageplus_creation, create_spatial_point_array
    ...
    def load_image(self, image_index):
        ...
        if self._is_image_plus_enabled() or self.camera_dropout > 0.0:
            ...
            # print("radar sample: ", radar_sample.shape, )
            ...
            # print("img_p_full: ", img_p_full.shape)
