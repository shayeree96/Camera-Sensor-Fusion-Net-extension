from crfnet_distance.utils.transform import random_transform_generator
from crfnet_distance.utils.anchor_parameters import AnchorParameters
from crfnet_distance.data_processing.generator.splits.nuscenes_splits import Scenes
from crfnet_distance.utils.anchor_calc import anchor_targets_bbox
from crfnet_distance.utils.anchor import guess_shapes
...
def create_generators(cfg, backbone):
  ...
  if 'nuscenes' in cfg.data_set:
    ...
    from crfnet_distance.data_processing.generator.nuscenes_generator import NuscenesGenerator
